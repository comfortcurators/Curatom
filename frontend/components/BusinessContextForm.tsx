...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    placeholder: "e.g. We run a portfolio of premium managed apartments and short-term stays.",
    required: true,
    multiline: true,
  },
  {
    ...
    placeholder: 'e.g. Business travellers and small groups booking 3-14 night stays in Delhi-NCR.',
    required: true,
    multiline: true,
  },
  {
    ...
    placeholder: 'e.g. AWS, Cloudflare, Zoho, GitHub, Claude, Gemini, our own booking app...',
    required: true,
    multiline: true,
  },
  {
    ...
    placeholder: 'e.g. Guest experience above all, then occupancy, then cost.',
    required: true,
    multiline: true,
  },
  {
    ...
    placeholder: 'e.g. Never quote a price without my sign-off.',
    required: false,
    multiline: true,
  },
  {
    ...
    placeholder: 'e.g. Warm but concise, never salesy.',
    required: false,
  },
  {
    key: 'anything_else',
