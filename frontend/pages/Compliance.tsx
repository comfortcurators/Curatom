...
export const DataWeCollect: React.FC = () => (
  <PageShell title="Data We Collect">
    ...
    <ul className="list-disc list-inside space-y-8">
      ...
      <li><strong className="text-ink-primary">Training-data consent</strong> — the Owner's yes/no on "let your data be used to improve Curatom" (Team page), plus who decided it and when. Unchecked by default; nothing currently reads this flag to actually train on or anonymize anything — see the Privacy Policy for the honest state of that.</li>
